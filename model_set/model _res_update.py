...
class G(nn.Module):
    def __init__(self, n_channel_input, n_channel_output, n_filters):
        ...
        self.block1=ResidualBlock(n_filters)
        self.block2=ResidualBlock(n_filters)
        self.block3=ResidualBlock(n_filters*2)
        self.block4=ResidualBlock(n_filters*2)
        self.block5=ResidualBlock(n_filters*4)
        self.block6=ResidualBlock(n_filters*4)
        self.block7=ResidualBlock(n_filters*8)
        self.block8=ResidualBlock(n_filters*8)
    ...
    def forward(self, input):
        ...
        res1=self.prelu(encoder1)
        res1=self.block1(res1)
        res2=self.block2(res1)
        #print(res2.shape)
        encoder2 = self.batch_norm2_1(self.conv2(self.leaky_relu(res2)))
        #print(encoder2.shape)
        res3=self.prelu(encoder2)
        res3=self.block3(res3)
        res4=self.block4(res3)
        encoder3 = self.batch_norm4_1(self.conv3(self.leaky_relu(res4)))
        #print(encoder3.shape)
        res5=self.prelu(encoder3)
        res5=self.block5(res5)
        res6=self.block6(res5)
        encoder4 = self.batch_norm8_1(self.conv4(self.leaky_relu(res6)))
        #print(encoder4.shape)
        res7=self.prelu(encoder4)
        res7=self.block7(res7)
        res8=self.block8(res7)
        encoder5 = self.batch_norm8_2(self.conv5(self.leaky_relu(res8)))
