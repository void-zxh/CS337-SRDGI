...
from ops import EqualConv2d,myConvTranspose2d,myBatchNorm2d
...
def weights_init(m):
    ...
    elif classname.find('myBatchNorm') != -1:
        m.gamma.data.normal_(1.0, 0.02)
        # print(str(classname))
        m.beta.data.fill_(0)
...
class G(nn.Module):
    def __init__(self, n_channel_input, n_channel_output, n_filters):
        ...
        print(n_filters)
        self.conv1 = EqualConv2d(n_channel_input, n_filters, 4, 2, 1)
        self.conv2 = EqualConv2d(n_filters, n_filters * 2, 4, 2, 1)
        self.conv3 = EqualConv2d(n_filters * 2, n_filters * 4, 4, 2, 1)
        self.conv4 = EqualConv2d(n_filters * 4, n_filters * 8, 4, 2, 1)
        self.conv5 = EqualConv2d(n_filters * 8, n_filters * 8, 4, 2, 1)
        self.conv6 = EqualConv2d(n_filters * 8, n_filters * 8, 4, 2, 1)
        self.conv7 = EqualConv2d(n_filters * 8, n_filters * 8, 4, 2, 1)
        self.conv8 = EqualConv2d(n_filters * 8, n_filters * 8, 4, 2, 1)

        self.deconv1 = myConvTranspose2d(n_filters * 8, n_filters * 8, 4, 2, 1)
        self.deconv2 = myConvTranspose2d(n_filters * 8 * 2, n_filters * 8, 4, 2, 1)
        self.deconv3 = myConvTranspose2d(n_filters * 8 * 2, n_filters * 8, 4, 2, 1)
        self.deconv4 = myConvTranspose2d(n_filters * 8 * 2, n_filters * 8, 4, 2, 1)
        self.deconv5 = myConvTranspose2d(n_filters * 8 * 2, n_filters * 4, 4, 2, 1)
        self.deconv6 = myConvTranspose2d(n_filters * 4 * 2, n_filters * 2, 4, 2, 1)
        self.deconv7 = myConvTranspose2d(n_filters * 2 * 2, n_filters, 4, 2, 1)
        self.deconv8 = myConvTranspose2d(n_filters * 2, n_channel_output, 4, 2, 1)

        self.batch_norm = myBatchNorm2d(n_filters)
        self.batch_norm2_1 = myBatchNorm2d(n_filters * 2)
        self.batch_norm2_2 = myBatchNorm2d(n_filters * 2)
        self.batch_norm4_1 = myBatchNorm2d(n_filters * 4)
        self.batch_norm4_2 = myBatchNorm2d(n_filters * 4)
        self.batch_norm8_1 = myBatchNorm2d(n_filters * 8)
        self.batch_norm8_2 = myBatchNorm2d(n_filters * 8)
        self.batch_norm8_3 = myBatchNorm2d(n_filters * 8)
        self.batch_norm8_4 = myBatchNorm2d(n_filters * 8)
        self.batch_norm8_5 = myBatchNorm2d(n_filters * 8)
        self.batch_norm8_6 = myBatchNorm2d(n_filters * 8)
        self.batch_norm8_7 = myBatchNorm2d(n_filters * 8)
        self.batch_norm8_8 = myBatchNorm2d(n_filters * 8)
    ...
    def forward(self, input):
        ...
        decoder1 = self.batch_norm8_5(self.deconv1(self.relu(encoder8)))
        decoder1 = torch.cat((encoder7,decoder1), 1)
        # print(decoder1.shape)
        decoder2 = self.batch_norm8_6(self.deconv2(self.relu(decoder1)))
        decoder2 = torch.cat((encoder6,decoder2), 1)
        # print(decoder2.shape)
        decoder3 = self.batch_norm8_7(self.deconv3(self.relu(decoder2)))
...
#         self.Conv1 = (ch_in=img_ch,ch_out=64)
